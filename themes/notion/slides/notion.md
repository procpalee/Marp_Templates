...
paginate: true
size: 16:9
header: 'Notion Theme — Workspace-Friendly'
...
# Your team's workspace, designed for any presentation.

## 15 brand-unique layouts that capture Notion's warm, structured tone.
...
## Soft canvas + ink — for everyday title slides.

team docs · 2026

---

<!-- _class: purple-section -->
<!-- _header: '' -->

# 01

## Foundations — color, type, and the database mindset.
...
## A simpler close for everyday workspace decks.

handle · @notion · notion.so
...
## Start a workspace in under a minute.
