...
디자인보다 흐름이 먼저예요. 카드 한 장에 한 가지 메시지, 그리고 그 메시지가 다음 카드를 부르도록.
...
1. **시각 언어 일치** — 슬라이드와 카드가 같은 톤
2. **차별화 요소** — 페이지네이션, 스와이프 CTA
3. **16개 레이아웃** — 표준 7 + Notion 7 + 신규 2
